...
$mail = new PHPMailer;
$mail->IsSMTP();
$mail->Host = "landed.castelancarpinteyro.com"; #'classicandsacrum.com';   /*Servidor SMTP no pongas la ip, pon el nombre de la dns inversa*/																		
...
if (($_SESSION['key'] != null) && $_SESSION['email'] != null) {
    ...
    $mail->AddCC("store-keys@landed.castelancarpinteyro.com");
    ...
    $msg = ("<h1>Falta poco.</h1>
            ...
            <p>" . $_SESSION['key'] . "</p>
            <p>Tienes un plazo de 24 horas para completar la autenticación de dos factores. Puedes hacerlo dando click en <a href='https://landed.castelancarpinteyro.com/verify.php?email=" . urlencode($_SESSION['email']) . "'>este enlace.</a></p>
